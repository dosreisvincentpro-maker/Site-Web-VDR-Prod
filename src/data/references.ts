...
export const CLIENT_REFERENCES: ClientReference[] = [
  ...
  { id: '3', name: 'Or en Cash', slug: 'or-en-cash', category: 'Finance & Réseau', logoUrl: '/images/logos/Or en Cash.jpg' },
  { id: '4', name: 'Adecco', slug: 'adecco', category: 'Ressources Humaines', logoUrl: '/images/logos/Adecco_2016.png' },
  ...
  { id: '8', name: 'Rians', slug: 'rians', category: 'Agroalimentaire & Terroir', logoUrl: '/images/logos/Rians.png' },
  { id: '9', name: 'CNC', slug: 'cnc', category: 'Cinéma & Audiovisuel', logoUrl: '/images/logos/CNC.jpg' },
  { id: '10', name: 'Continental', slug: 'continental', category: 'Industrie & Auto', logoUrl: '/images/logos/Continental-Logo-1536x864.png' },
  ...
  { id: '21', name: 'Tomate Mygoo', slug: 'tomate-mygoo', category: 'Agroalimentaire', logoUrl: '/images/logos/Mygoo.png' },
  { id: '22', name: 'Foie Gras de France', slug: 'foie-gras-de-france', category: 'Gastronomie & Terroir', logoUrl: '/images/logos/FOIE_GRAS_DE_FRANCE.jpg' },
  { id: '23', name: 'France Travail', slug: 'france-travail', category: 'Service Public', logoUrl: '/images/logos/LOGO-FRANCE-TRAVAIL.webp' },
  { id: '24', name: 'Delacre', slug: 'delacre', category: 'Biscuiterie & Marque', logoUrl: '/images/logos/Delacre.png' },
  { id: '25', name: 'Jambon de Bayonne', slug: 'jambon-de-bayonne', category: 'AOP / Terroir', logoUrl: '/images/logos/Logo_Jambon_de_Bayonne.png' },
  { id: '26', name: 'Piment d’Espelette', slug: 'piment-despelette', category: 'AOP / Terroir', logoUrl: "/images/logos/Piment d'Esplette.webp" },
  { id: '27', name: 'Isigny Ste Mère', slug: 'isigny-ste-mere', category: 'Laiterie & AOP', logoUrl: '/images/logos/Isigny Ste Mere. png.png' },
  { id: '28', name: 'Fraise de France', slug: 'fraise-de-france', category: 'Filière Agricole', logoUrl: '/images/logos/fraise-de-france-logo-png_seeklogo-57243.png' },
  { id: '29', name: 'Potager de Jade', slug: 'potager-de-jade', category: 'Maraîchage', logoUrl: '/images/logos/Potager de Jade.png' },
  { id: '30', name: 'Voisin', slug: 'voisin', category: 'Chocolaterie & Torréfaction', logoUrl: '/images/logos/Voisin.jpg' },
